                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-7">
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <div class="ms-3">
                                                    ...
                                                    <div class="mt-2 small lh-1">
                                                        <a href="{{ route('carts.destroy', [$item->id]) }}" onclick="return confirm('Apa Anda yakin ingin menghapus pesanan ini?')" class="text-decoration-none text-inherit">
                            ...
                            <div class="d-flex justify-content-between mt-4">
                                ...
                                <button type="submit" class="btn btn-second">Perbarui Keranjang</button>
                            </div>
                            {{ html()->form()->close() }}
                        </div>
                        <div class="col-12 col-lg-4 col-md-5">
                            <div class="mb-5 card mt-6 shadow">
                                <div class="card-body p-6">
                                    <!-- heading -->
                                    <h2 class="h5 mb-4">Ringkasan Pembayaran</h2>
                                    <div class="card mb-2">
                                        <!-- list group -->
                                        <ul class="list-group list-group-flush">
                                            <!-- list group item -->
