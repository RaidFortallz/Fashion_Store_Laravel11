                ...
                <div class="widget-content widget-categories">
                  <ul class="nav nav-category">
                    <li class="nav-item border-bottom w-100">
                      <a class="nav-link active" aria-current="page" href="#">Pakaian <i class='bx bx-chevron-right'></i></a>
                    </li>
                    <li class="nav-item border-bottom w-100">
                      <a class="nav-link" href="#">Sepatu <i class='bx bx-chevron-right'></i></a>
                    </li>
                    <li class="nav-item border-bottom w-100">
                      <a class="nav-link" href="#">Tas <i class='bx bx-chevron-right'></i></a>
                    </li>
                    <li class="nav-item border-bottom w-100">
                      <a class="nav-link" href="#">Elektronik <i class='bx bx-chevron-right'></i></a>
                    </li>
                    <li class="nav-item border-bottom w-100">
                      <a class="nav-link" href="#">Aksesoris <i class='bx bx-chevron-right'></i></a>
                    </li>
                  </ul>                  
                </div>
              </div>
