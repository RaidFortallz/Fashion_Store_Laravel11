...
class OrderController extends Controller
{
    ...
    public function __construct(AddressRepositoryInterfaces $addressRepository, 
    CartRepositoryInterfaces $cartRepository, OrderRepositoryInterfaces $orderRepository) {
